...
<form method="Post" action="novoEvento.html">
    <label>Código:</label><input type="text" name="codigo" value="" size="50" pattern="[A-Z0-9\s]+$"/>
    <label>Titulo:</label><input type="text" name="titulo" value="" size="50" pattern="[A-Z0-9\s]+$"/>
